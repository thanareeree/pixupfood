...
<html>
    <head>
        ...
        <!-- custom css -->
        <link rel="stylesheet" href="/assets/css/cus-blocked.css">
                        ...
                        <div class="row"  >
                            <div class="col-md-12 wow fadeInUp" style="margin-top: 50px;margin-left: 100px; margin-bottom: 60px"  data-wow-delay="0.6s">
                                ...
                                <div class="col-md-9 content2 center-block">
                                    <div class="col-md-12" >
                                        <h3 style="text-align: center">บัญชีผู้ใช้ของท่านถูกระงับการใช้งานเว็บชั่วคราว</h3><br>
                                        <h3 style="text-align: center">กรุณาติดต่อ Admin เพื่อขออนุญาตเข้าใช้งานเว็บ</h3><br>
