                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-content"> 
                                                        ...
                                                        <form action="#" method="get" id="addMenuRes">
                                                            <div>
                                                                ...
                                                                <span style="margin-left: 25px;font-size: 18px;" id="type" > รายการอาหาร </span>&nbsp;&nbsp;
                                                                ...
                                                                <input type="priceinput" style="font-size: 18px;">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="card" style="margin-top: 1px;">
                                                            <div class="card-action">
                                                                ...
                                                                <div class="row" style="margin:10px 0 0 5px;">
                                                                    <span style="margin-left: 24px;"> ชื่ออาหาร </span> &nbsp;<span id="show_menu"></span>
